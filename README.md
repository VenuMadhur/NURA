...
Uses NURA to manage their own health.

Circle Head

Creates a trusted Circle and helps coordinate care for connected or managed people.

Managed Member

Has a profile managed by an authorized person but does not yet have a NURA account.

Connected Member

Has their own NURA account and joins a Circle with controlled permissions.
...
Established initial NURA project structure

Created reusable React components

Added NURA header and tagline
